...
void odometry_apply_diameter_delta(float delta, int left_plus_right_minus); // +1 表示左加右减；-1 表示左减右加
void odometry_recompute_config(struct sOdometryTrack *ot); // 依据当前全局标定值，重算 ot->configuration
